...
> Ideogram JSON Prompt 可视化编辑器

[**English**](./README.md) · [报告 Bug](https://github.com/SurpassHR/ideogram4-editor/issues) · [功能建议](https://github.com/SurpassHR/ideogram4-editor/issues) — 在画布上拖拽创建边界框，配置描述与颜色，生成 Ideogram 4 图像生成模型所需的 JSON prompt，并通过 ComfyUI API 生成图片。
...
- ⚡ **SSE 流式输出** — LLM 回复逐 token 流式渲染，两个对话面板（per-box AI 对话 + 画布级构图对话）均支持
